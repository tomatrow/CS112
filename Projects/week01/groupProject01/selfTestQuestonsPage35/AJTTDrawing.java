...
public class AJTTDrawing {
	...
	private static void drawSmile(Graphics2D context, Point faceCoords, int happiness, int diameter) {
		...
		arc.moveTo(0,0);
		// arc.curveTo((double)smilePolyLineX[0],(double)smilePolyLineY[0],
		// 	(double)smilePolyLineX[2],(double)smilePolyLineY[2],
		// 	(double)smilePolyLineX[4],(double)smilePolyLineY[4]);
		arc.curveTo(0,0,150,400,300,0);
